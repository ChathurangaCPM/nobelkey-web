            ...
            <div className="w-full p-6 py-20 lg:w-11/12 xl:px-0 gap-5 xl:max-w-[1400px] mx-auto bg-white relative z-20 rounded-md flex flex-col lg:flex-row justify-between items-start">
                <div className="flex-1">
                    <div className="w-[100%] flex flex-col gap-4">
                        {title && <div className="relative pl-4 text-right">
                            <h1 className="text-[20px] font-headingFontExtraBold leading-[35px] font-extrabold border-r-4 border-r-[#3C51A3] pr-4" dangerouslySetInnerHTML={{ __html: title || ''}}></h1>
                        </div>}
                ...
                <div className="flex-1 flex flex-col justify-center gap-5">
                    {description && <p className="text-sm max-w-[80%]">{description}</p>}
