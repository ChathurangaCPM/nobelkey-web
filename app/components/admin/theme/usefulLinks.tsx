...
const AdminFooterUsefulLinks: React.FC = () => {
        ...
        <div className="space-y-4">
            ...
            {fields.length === 0 && (
                <div className="text-center p-4 border border-dashed rounded-lg text-muted-foreground">
                    No useful links added. Click the button above to add your first link.
                </div>
            )}
            <Button
                type="button"
...
export default AdminFooterUsefulLinks;